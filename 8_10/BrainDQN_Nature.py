...
class BrainDQN:
    ...
    def createQNetwork(self):
        # network weights
        W_conv1 = self.weight_variable([3, 3, 6, 32])
        ...
        W_fc1 = self.weight_variable([18432, 128])
        ...
        stateInput = tf.placeholder("float", [None, 12, 12, 6])
        ...
        h_conv3_flat = tf.reshape(h_conv3, [-1, 18432])
    ...
    def getAction(self):
        ...
        if self.timeStep % FRAME_PER_ACTION == 0:
            ...
            action[0] = 1  # do nothing terminal
